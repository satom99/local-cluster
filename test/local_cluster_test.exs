defmodule LocalClusterTest do
  ...
  test "overriding environment variables on child nodes" do
    ...
    node1_env = :erpc.call(node1, Application, :get_env, [:local_cluster, :override])
    node2_env = :erpc.call(node2, Application, :get_env, [:local_cluster, :override])
    node3_env = :erpc.call(node3, Application, :get_env, [:local_cluster, :override])
